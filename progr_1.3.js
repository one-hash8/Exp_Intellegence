...
// Global helper functions for sliders
...
let t, frameN, continueRoutine, globalClock, routineTimer, frameDur, currentLoop;
let faces_file, idioms_file, faces_rows, idioms_rows, n_faces, n_idioms, face_order, idioms_order, n_pairs;
let sliders, _prev_pressed, pressed, _mouseButtons, _mouseXYs, gotValidClick;
let variants1, variants2, variants3, variants4, face;
let raven_task_path, raven_2_path, rebus_pic, idioma_pic_path, emo_right, idioma_answer_path, prevButtonState, rebus_variants, progress_str;
let _key_resp_allKeys, _key_resp_3_allKeys, _key_resp_32_allKeys, _key_resp_7_allKeys;
let _key_raven_test_allKeys, _key_insight_fake_solve_allKeys, _aha_fake_key_allKeys, mx;
let _key_resp_10_allKeys, _key_resp_33_allKeys, _key_resp_34_allKeys, _key_resp_35_allKeys;
let _key_resp_25_allKeys, _insight_fake_key_allKeys, _key_resp_5_allKeys, _key_resp_26_allKeys;
let _key_aha_fake_solve_allKeys, _key_resp_24_allKeys, _key_resp_12_allKeys, _key_resp_6_allKeys;
let _key_resp_28_allKeys, _key_resp_21_allKeys, _key_diff_allKeys, _key_resp_11_allKeys;
let _key_resp_30_allKeys, _key_resp_14_allKeys, _key_resp_9_allKeys;
let _key_resp_31_allKeys, _key_resp_36_allKeys, _key_idioma_task_allKeys;
let _key_resp_20_allKeys, _key_resp_37_allKeys, _key_aha_idioms_allKeys;
let curr, total, level, val;
let instr_1MaxDurationReached, instr_1MaxDuration, instr_1Components;
let instr_insightMaxDurationReached, instr_insightMaxDuration, instr_insightComponents;
let aha_instrMaxDurationReached, aha_instrMaxDuration, aha_instrComponents;
let instr_raven_1MaxDurationReached, instr_raven_1MaxDuration, instr_raven_1Components;
let raven_1_testtMaxDurationReached, raven_1_testtMaxDuration, raven_1_testtComponents;
let insight_fake_solveMaxDurationReached, insight_fake_solveMaxDuration, insight_fake_solveComponents;
let aha_fakeMaxDurationReached, aha_fakeMaxDuration, aha_fakeComponents;
let faces1_instrMaxDurationReached, faces1_instrMaxDuration, faces1_instrComponents;
let faces1_test_faceMaxDurationReached, faces1_test_faceMaxDuration, faces1_test_faceComponents;
let faces1_var_testMaxDurationReached, faces1_var_testMaxDuration, faces1_var_testComponents;
let faces_var_answer_testMaxDurationReached, faces_var_answer_testMaxDuration, faces_var_answer_testComponents;
let idiom_instr_1MaxDurationReached, idiom_instr_1MaxDuration, idiom_instr_1Components;
let idiom1_testMaxDurationReached, idiom1_testMaxDuration, idiom1_testComponents;
let true_or_not_instrMaxDurationReached, true_or_not_instrMaxDuration, true_or_not_instrComponents;
let insight_fakeMaxDurationReached, insight_fakeMaxDuration, insight_fakeComponents;
let block_2_startMaxDurationReached, block_2_startMaxDuration, block_2_startComponents;
let fixateMaxDurationReached, fixateMaxDuration, fixateComponents;
let ravenMaxDurationReached, ravenMaxDuration, ravenComponents;
let aha_fake_solveMaxDurationReached, aha_fake_solveMaxDuration, aha_fake_solveComponents;
let faces_1_faceMaxDurationReached, faces_1_faceMaxDuration, faces_1_faceComponents;
let faces_1_varMaxDurationReached, faces_1_varMaxDuration, faces_1_varComponents;
let faces_1_answerMaxDurationReached, faces_1_answerMaxDuration, faces_1_answerComponents;
let idioms1_imageMaxDurationReached, idioms1_imageMaxDuration, idioms1_imageComponents;
let true_or_notMaxDurationReached, true_or_notMaxDuration, true_or_notComponents;
let break_2MaxDurationReached, break_2MaxDuration, break_2Components;
let block_2_instrMaxDurationReached, block_2_instrMaxDuration, block_2_instrComponents;
let instr_2_ravenMaxDurationReached, instr_2_ravenMaxDuration, instr_2_ravenComponents;
let raven_2_instrMaxDurationReached, raven_2_instrMaxDuration, raven_2_instrComponents;
let raven_gradeMaxDurationReached, raven_gradeMaxDuration, raven_gradeComponents;
let idiom_instrMaxDurationReached, idiom_instrMaxDuration, idiom_instrComponents;
let idiom_testMaxDurationReached, idiom_testMaxDuration, idiom_testComponents;
let idioms_answerMaxDurationReached, idioms_answerMaxDuration, idioms_answerComponents;
let grade_idioms_testMaxDurationReached, grade_idioms_testMaxDuration, grade_idioms_testComponents;
let raven_1MaxDurationReached, raven_1MaxDuration, raven_1Components;
let idioms_taskMaxDurationReached, idioms_taskMaxDuration, idioms_taskComponents;
let idioms_right_answerMaxDurationReached, idioms_right_answerMaxDuration, idioms_right_answerComponents;
let ahaMaxDurationReached, ahaMaxDuration, ahaComponents;
let grade_testMaxDurationReached, grade_testMaxDuration, grade_testComponents;
let break_1MaxDurationReached, break_1MaxDuration, break_1Components;
let GoodbyMaxDurationReached, GoodbyMaxDuration, GoodbyComponents;
// Component variables
let progress_lbl;
let instr_1Clock, text, key_resp;
...
let faces1_test_faceClock, img_faces_1_test;
let faces1_var_testClock, text_100, text_200, text_300, text_400, key_resp_33, img_000;
let faces_var_answer_testClock, text_28, image_6;
let idiom_instr_1Clock, text_29, key_resp_34;
let idiom1_testClock, image_7, key_resp_35;
let true_or_not_instrClock, image_45, text_20, text_21, key_resp_25;
let insight_fakeClock, insight_fake_text, insight_fake_key;
let block_2_startClock, text_4, key_resp_5;
let fixateClock, polygon;
let ravenClock, image, key_resp_26;
let aha_fake_solveClock, text_aha_fake_solve, key_aha_fake_solve;
let faces_1_faceClock, img_faces_1_face;
let faces_1_varClock, text_faces1_1, text_faces1_2, text_faces1_3, text_faces1_4, img_faces1_var, key_resp_24;
let faces_1_answerClock, img_faces_1_answer, text_faces_1_answer;
let idioms1_imageClock, image_5;
let true_or_notClock, image_47, text_23, text_24, key_resp_12;
let break_2Clock, text_5, key_resp_6;
let block_2_instrClock, text_25, key_resp_28;
let instr_2_ravenClock, text_instr2_raven, key_resp_21;
let raven_2_instrClock, image_2;
let raven_gradeClock, key_diff, text_raven_grade, slider_raven, mouse_raven, text_100_raven, text_0_raven;
let idiom_instrClock, text_12, key_resp_11;
let idiom_testClock, image_4, key_resp_31;
let idioms_answerClock, text_13, image_44, text_31, key_resp_36;
let grade_idioms_testClock, key_resp_30, mouse_2, slider_orig_test, text_orig_test, text_0_orig_test, text_100_orig_test_2;
let raven_1Clock, image_raven_1_test;
let idioms_taskClock, idioma, key_idioma_task;
let idioms_right_answerClock, text_right_idiom, image_right_idiom, key_resp_20, text_insight_idioms_2, key_resp_37;
let ahaClock, text_aha_idioms, key_aha_idioms;
let grade_testClock, key_resp_14, mouse, slider_originality_test, text_originality_test, text_0_originality_test, text_100_originality_test;
let break_1Clock, text_32, key_resp_9, my;
let GoodbyClock, text_15;
// Loop variables
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'pics/Surprise!/surprise_10.png', 'path': 'pics/Surprise!/surprise_10.png'},
    ...
    {'name': 'pics/Sadness/sadness_4.png', 'path': 'pics/Sadness/sadness_4.png'},
    ...
    {'name': 'default.png', 'path': 'idioms/idioms_1/СС_О.png'},
...
async function updateInfo() {
  ...
  // Disable file downloads - set dataFileName to empty to prevent downloads
  psychoJS.experiment.dataFileName = '';
  psychoJS.experiment.field_separator = ',';
  
  // Override save methods early to prevent any file downloads
  if (psychoJS.experiment.saveAsExcel) {
    psychoJS.experiment.saveAsExcel = function() {
      return Promise.resolve();
    };
  }
  if (psychoJS.experiment.saveAsWideText) {
    psychoJS.experiment.saveAsWideText = function() {
      return Promise.resolve();
    };
  }
  if (psychoJS.experiment.saveAsCsv) {
...
async function experimentInit() {
  // Disable file downloads at experiment start
  // Override URL.createObjectURL to prevent blob downloads
  ...
  // Override download attribute creation
  ...
  document.createElement = function(tagName, options) {
    ...
    if (tagName.toLowerCase() === 'a') {
      ...
      element.click = function() {
        ...
        if (href && (href.startsWith('blob:') || href.includes('.xlsx') || href.includes('.csv'))) {
          return;
        }
  ...
  // Run 'Begin Experiment' code from code_6
          ...
          // add-on: shuffle array using Fisher-Yates algorithm
...
function instr_insightRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instr_insightComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function aha_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of aha_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_block_1LoopBegin(instr_block_1LoopScheduler, snapshot) {
  return async function() {
    ...
    for (let _thisInstr_block_1 of instr_block_1) {
...
function block_1LoopBegin(block_1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const _thisBlock_1 of block_1) {
...
function instr_2LoopBegin(instr_2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const _thisInstr_2 of instr_2) {
...
function faces_loopLoopBegin(faces_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // set up handler to look after randomisation of conditions etc
    // face_order is a function that returns an array, so we need to call it first
    const face_order_array = typeof face_order === 'function' ? face_order() : face_order;
    const face_index = face_order_array && face_order_array[pairs.thisN] !== undefined ? face_order_array[pairs.thisN] : 0;
    let faces_trialList;
    try {
      faces_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/faces2_cond1.xlsx', [face_index]);
      if (!faces_trialList || faces_trialList.length === 0) {
        console.warn('Faces trialList is empty, using full file');
        faces_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/faces2_cond1.xlsx');
      }
    } catch (error) {
      console.error('Error importing faces conditions:', error);
      // Fallback to importing full file
      faces_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/faces2_cond1.xlsx');
    }
    ...
    // Schedule all the trials in the trialList:
    for (const _thisFaces_loop of faces_loop) {
...
function idioms_loopLoopBegin(idioms_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // set up handler to look after randomisation of conditions etc
    // idioms_order is a function that returns an array, so we need to call it first
    const idioms_order_array = typeof idioms_order === 'function' ? idioms_order() : idioms_order;
    const idiom_index = idioms_order_array && idioms_order_array[pairs.thisN] !== undefined ? idioms_order_array[pairs.thisN] : 0;
    let idioms_trialList;
    try {
      idioms_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/idioms1_cond1.xlsx', [idiom_index]);
      if (!idioms_trialList || idioms_trialList.length === 0) {
        console.warn('Idioms trialList is empty, using full file');
        idioms_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/idioms1_cond1.xlsx');
      }
    } catch (error) {
      console.error('Error importing idioms conditions:', error);
      // Fallback to importing full file
      idioms_trialList = await TrialHandler.importConditions(psychoJS.serverManager, 'tables/idioms1_cond1.xlsx');
    }
    ...
    // Schedule all the trials in the trialList:
    for (const _thisIdioms_loop of idioms_loop) {
...
function instr_raven_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instr_raven_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function insight_fake_solveRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of insight_fake_solveComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function insight_fake_solveRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('key_insight_fake_solve.keys', key_insight_fake_solve.keys);
    if (typeof key_insight_fake_solve.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('key_insight_fake_solve.rt', key_insight_fake_solve.rt);
        psychoJS.experiment.addData('key_insight_fake_solve.duration', key_insight_fake_solve.duration);
        routineTimer.reset();
    }
...
function aha_fakeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of aha_fakeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function aha_fakeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('aha_fake_key.keys', aha_fake_key.keys);
    if (typeof aha_fake_key.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('aha_fake_key.rt', aha_fake_key.rt);
        psychoJS.experiment.addData('aha_fake_key.duration', aha_fake_key.duration);
        routineTimer.reset();
    }
    aha_fake_key.stop();
...
function faces1_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces1_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function faces1_test_faceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces1_test_faceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function faces1_var_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces1_var_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function faces_var_answer_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces_var_answer_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idiom_instr_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of idiom_instr_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idiom1_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of idiom1_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function true_or_not_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of true_or_not_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function insight_fakeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of insight_fakeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function insight_fakeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('insight_fake_key.keys', insight_fake_key.keys);
    if (typeof insight_fake_key.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('insight_fake_key.rt', insight_fake_key.rt);
        psychoJS.experiment.addData('insight_fake_key.duration', insight_fake_key.duration);
        routineTimer.reset();
    }
...
function block_2_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of block_2_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixateRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ravenRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    if (typeof raven_2_path !== 'undefined' && raven_2_path) {
    ...
    for (const thisComponent of ravenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function aha_fake_solveRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of aha_fake_solveComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function aha_fake_solveRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('key_aha_fake_solve.keys', key_aha_fake_solve.keys);
    if (typeof key_aha_fake_solve.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('key_aha_fake_solve.rt', key_aha_fake_solve.rt);
        psychoJS.experiment.addData('key_aha_fake_solve.duration', key_aha_fake_solve.duration);
        routineTimer.reset();
    }
...
function faces_1_faceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces_1_faceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function faces_1_varRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of faces_1_varComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function faces_1_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    if (typeof emo_right !== 'undefined' && emo_right) {
    ...
    for (const thisComponent of faces_1_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idioms1_imageRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    if (typeof rebus_pic !== 'undefined' && rebus_pic) {
    ...
    for (const thisComponent of idioms1_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function true_or_notRoutineBegin(snapshot) {
  return async function () {
    ...
    if (typeof rebus_variants !== 'undefined' && rebus_variants) {
    ...
    for (const thisComponent of true_or_notComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function block_2_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of block_2_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_2_ravenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instr_2_ravenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function raven_2_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of raven_2_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function raven_gradeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of raven_gradeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idiom_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of idiom_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idiom_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of idiom_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idioms_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of idioms_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function grade_idioms_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of grade_idioms_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idioms_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    if (typeof idioma_pic_path !== 'undefined' && idioma_pic_path) {
    ...
    for (const thisComponent of idioms_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function idioms_right_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    if (typeof idioma_answer_path !== 'undefined' && idioma_answer_path) {
    ...
    for (const thisComponent of idioms_right_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ahaRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ahaComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function grade_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of grade_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function GoodbyRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of GoodbyComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function importConditions(snapshot) {
  return async function () {
    // Restore loop state from snapshot
    TrialHandler.fromSnapshot(snapshot);
    // Use currentLoop which should be set before calling this function
    // If currentLoop is not set, try to get it from the experiment
    let loop = currentLoop;
    if (!loop || loop === psychoJS.experiment) {
      // Try to get the most recent loop
      if (psychoJS.experiment._unfinishedLoops && psychoJS.experiment._unfinishedLoops.length > 0) {
        loop = psychoJS.experiment._unfinishedLoops[psychoJS.experiment._unfinishedLoops.length - 1];
      }
    }
    
    if (loop && loop.getCurrentTrial) {
      const trial = loop.getCurrentTrial();
      if (trial) {
        // Import all attributes from trial to global scope
        psychoJS.importAttributes(trial);
        
        // Manually assign variables from trial to ensure they're in global scope
        // This is needed because importAttributes may not work in module context
        // Helper function to add .png extension if missing and path looks like an image
        function ensureImageExtension(path) {
          if (!path || typeof path !== 'string') return path;
          // If path doesn't have an extension and looks like an image path, add .png
          if (!path.match(/\.(png|jpg|jpeg|gif|bmp)$/i) && 
              (path.includes('pics/') || path.includes('conf_pics/') || path.includes('raven_') || path.includes('idioms/'))) {
            return path + '.png';
          }
          return path;
        }
        
        if ('raven_task_path' in trial) raven_task_path = ensureImageExtension(trial.raven_task_path);
        if ('raven_2_path' in trial) raven_2_path = ensureImageExtension(trial.raven_2_path);
        if ('face' in trial) face = ensureImageExtension(trial.face);
        if ('rebus_pic' in trial) rebus_pic = ensureImageExtension(trial.rebus_pic);
        if ('idioma_pic_path' in trial) idioma_pic_path = ensureImageExtension(trial.idioma_pic_path);
        if ('emo_right' in trial) emo_right = ensureImageExtension(trial.emo_right);
        if ('idioma_answer_path' in trial) idioma_answer_path = ensureImageExtension(trial.idioma_answer_path);
        if ('rebus_variants' in trial) rebus_variants = trial.rebus_variants;
        if ('variants1' in trial) variants1 = trial.variants1;
        if ('variants2' in trial) variants2 = trial.variants2;
        if ('variants3' in trial) variants3 = trial.variants3;
        if ('variants4' in trial) variants4 = trial.variants4;
    ...
    // This is needed because Excel on Windows may use backslashes in paths
    if (typeof raven_task_path !== 'undefined' && raven_task_path) {
      raven_task_path = raven_task_path.replace(/\\/g, '/');
    }
    if (typeof raven_2_path !== 'undefined' && raven_2_path) {
      raven_2_path = raven_2_path.replace(/\\/g, '/');
    }
    if (typeof face !== 'undefined' && face) {
      face = face.replace(/\\/g, '/');
    }
    if (typeof rebus_pic !== 'undefined' && rebus_pic) {
      rebus_pic = rebus_pic.replace(/\\/g, '/');
    }
    if (typeof idioma_pic_path !== 'undefined' && idioma_pic_path) {
      idioma_pic_path = idioma_pic_path.replace(/\\/g, '/');
    }
    if (typeof emo_right !== 'undefined' && emo_right) {
      emo_right = emo_right.replace(/\\/g, '/');
    }
    if (typeof idioma_answer_path !== 'undefined' && idioma_answer_path) {
      idioma_answer_path = idioma_answer_path.replace(/\\/g, '/');
    }
    if (typeof rebus_variants !== 'undefined' && rebus_variants) {
      // rebus_variants is text, not a path, so no need to normalize
    }
    return Scheduler.Event.NEXT;
    };
}
...
async function sendDataToOnlineExcel(data) {
  try {
    ...
    const GOOGLE_SHEETS_WEBHOOK_URL = 'https://script.google.com/macros/s/AKfycbyfVSUDOKVcmalldXo8yHURR9JjOYGaN_uVsG5fAf_pCyCrSesrVnKlsF5Po8bJHSjI/exec'; // Замените на ваш URL

    // Ensure date is set before sending
    ...
    const payload = {
      ...
      date: expInfo['date'] || util.MonotonicClock.getDateStr(),
      expName: expInfo['expName'] || expName,
...
function convertExperimentDataToFlatFormat() {
  try {
    // PsychoJS stores data in _trialsData, not in data property
    let entries = [];
    
    // PsychoJS stores trial data in _trialsData array
    if (psychoJS.experiment._trialsData && Array.isArray(psychoJS.experiment._trialsData)) {
      entries = psychoJS.experiment._trialsData;
    } else if (psychoJS.experiment._trialsData && typeof psychoJS.experiment._trialsData === 'object') {
      // If it's an object, convert to array
      entries = Object.values(psychoJS.experiment._trialsData);
    } else if (Array.isArray(psychoJS.experiment.data)) {
      // Fallback to data if it exists
      entries = psychoJS.experiment.data;
    } else {
      console.warn('No data found in _trialsData or data. Available properties:', Object.keys(psychoJS.experiment));
      return [];
    }
    
    if (!entries || entries.length === 0) {
      console.warn('No data entries found after all checks');
      return [];
    }
    ...
    // Fields to exclude from trial data
    const excludeFields = [
      'participant', 'date', 'expName', 'gender', 'age', 
      'OS', 'frameRate', 'psychopyVersion', 'row_number',
      // Specific fields to exclude
      'rebus_pic', 'raven_2_path', 'variants1', 'variants2', 
      'variants3', 'variants4', 'img1_path', 'img2_path', 
      'idioma_pic_path'
    ];
    ...
    const cleanedEntries = entries.map((entry) => {
      ...
      for (const key in entry) {
        // Skip if key is in excludeFields
        if (excludeFields.includes(key)) {
          continue;
        }
        
        // Skip if key contains any exclude pattern
        ...
        // Skip if key contains "mouse" (case insensitive)
    ...
    // Key renaming map - rename keys after cleaning
    const keyRenames = {
      'key_resp_37': 'key_idioms_insight',
      'key_resp_24': 'key_faces_anwer',
      'key_resp_12': 'key_true_not'
    };
    
    // Rename keys in cleaned entries
    const renamedEntries = cleanedEntries.map((entry) => {
      const renamed = {};
      for (const key in entry) {
        // Rename keys if needed
        let newKey = key;
        for (const oldKey in keyRenames) {
          if (key.startsWith(oldKey)) {
            newKey = key.replace(oldKey, keyRenames[oldKey]);
            break;
          }
        }
        renamed[newKey] = entry[key];
      }
      return renamed;
    });
    
    // Return single entry per participant with all trial data in 'data' field
    const result = [{
      participant: expInfo['participant'] || 'unknown',
      date: expInfo['date'] || util.MonotonicClock.getDateStr(),
      expName: expInfo['expName'] || expName,
    ...
    console.error('Error converting experiment data:', error);
    console.error('Error stack:', error.stack);
    // Return at least participant info
    return [{
      participant: expInfo['participant'] || 'unknown',
      date: expInfo['date'] || util.MonotonicClock.getDateStr(),
      expName: expInfo['expName'] || expName,
      ...
      age: expInfo['age'] || '',
      data: [],
      error: 'Failed to convert data: ' + error.message
    }];
  }
}
...
async function quitPsychoJS(message, isCompleted) {
  ...
  // Disable file downloads - we only send to online Excel
  // Override the save methods to prevent file downloads
  if (psychoJS.experiment.saveAsExcel) {
    psychoJS.experiment.saveAsExcel = function() {
      return Promise.resolve();
    };
  ...
  if (isCompleted) {
    try {
      ...
      const experimentData = convertExperimentDataToFlatFormat();
  ...
  // Disable file downloads in quit options
  psychoJS.quit({message: message, isCompleted: isCompleted, saveData: false});
